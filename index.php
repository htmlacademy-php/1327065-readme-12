...
function cut_text ($text, $symbols = 300) {
    if (mb_strlen($text) < $symbols) {
        ...
        $format_post = "<p>" . implode(" ",array_slice($gap_count, 0, $i)) . "..." . "</p>" . "<a class=\"post-text__more-link\" href=\"#\">Читать далее</a>";
        return $format_post;
    }
}
...
<section class="page__main page__main--popular">
    ...
    <div class="popular container">
        ...
        <div class="popular__posts">
            ...
            <!-- тип поста -->
            <article class="popular__post post <?php print($val['type']); ?>">
                <header class="post__header">
                    <!--здесь заголовок-->
                    <h2><?php print($val['title']); ?></h2>
                </header>
                <div class="post__main">
                <!--здесь содержимое карточки-->
                <?php if ($val['type'] == 'post-text'): ?>
                    <!--содержимое для поста-текста-->
                    <p><?php print(cut_text($val['content'])); ?></p>
                ...
                <?php elseif ($val['type'] == 'post-photo'): ?>
                    ...
                    <div class="post-photo__image-wrapper">
                        <img src="img/<?php print($val['content']); ?>" alt="Фото от пользователя" width="360" height="240">
                    </div>
                <?php elseif ($val['type'] == 'post-link'): ?>
                    <!--содержимое для поста-ссылки-->
                    <div class="post-link__wrapper">
                        <a class="post-link__external" href="http://<?php print($val['content']); ?>" title="Перейти по ссылке">
                    ...
                    <div class="post__author">
                        <a class="post__author-link" href="#" title="Автор">
                            <div class="post__avatar-wrapper">
                                ...
                                <img class="post__author-avatar" src="img/<?php print($val['avatar']); ?>" alt="Аватар пользователя">
                            </div>

<section class="adding-post__quote tabs__content tabs__content--active">
    ...
    <form class="adding-post__form form" action="add.php" method="post">
        <input type="hidden" value="quote" name="type"> <!-- Крутая фича, запомни. Значения value и name произвольные -->
                ...
                <div class="adding-post__input-wrapper form__textarea-wrapper">
                    ...
                    <div class="form__input-section">
                                            <textarea
                                                ...
                                                name="cite-text" id="cite-text" placeholder="Текст цитаты"></textarea>
                        <button class="form__error-button button" type="button">!<span
                                class="visually-hidden">Информация об ошибке</span></button>
                        <div class="form__error-text">
                            <h3 class="form__error-title">Заголовок сообщения</h3>

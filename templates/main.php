                    ...
                    <div class="post__main">
                        ...
                        <?php elseif ($val['icon'] == 'photo'): ?>
                            ...
                            <div class="post-photo__image-wrapper">
                                <img src="<?= ($val['image_content']); ?>" alt="Фото от пользователя" width="360"
                                     height="240">
                            </div>
                        <?php elseif ($val['icon'] == 'link'): ?>
                            <!--содержимое для поста-ссылки-->
                            <div class="post-link__wrapper">
                                <a class="post-link__external" href="http://<?= ($val['link_content']); ?>" target="_blank" rel="nofollow"
                                   title="Перейти по ссылке">
                                    <div class="post-link__info-wrapper">
                                        <div class="post-link__icon-wrapper">
                                            <img src="https://www.google.com/s2/favicons?domain=<?= ($val['link_content']); ?>"
                                                 alt="Иконка">
                                        </div>
                        ...
                        <?php elseif ($val['icon'] == 'video'): ?>
                            ...
                            <div class="post-video__block">
                                <div class="post-video__preview">
                                    <?= embed_youtube_cover($val['video_content']); ?>
                                </div>
                                <a href="<?= ($val['video_content']); ?>" target="_blank" rel="nofollow" class="post-video__play-big button">

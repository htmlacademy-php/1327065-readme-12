<main class="page__main page__main--publication">
    <div class="container">
        <?php foreach ($postShow as $key => $val): ?>
            <h1 class="page__title page__title--publication"><?= ($val['title']); ?></h1>
                ...
                <div class="post-details__wrapper post-<?= ($val['icon']); ?>">
                    <div class="post-details__main-block post post--details" style="border-radius: 0 0 30px 30px;">
                        ...
                        <div class="post__indicators">
                            ...
                            <span class="post__view"><?= ($val['show_count']); ?> просмотров</span>
                        </div>
                        <div class="comments">
                                    ...
                                    <li class="comments__item user">
                                        ...
                                        <div class="comments__info">
                                            ...
                                            <p class="comments__text">
                                                ...
                                                Листвянка, расположенная на западном берегу озера, – популярная
                                                отправная
                                                точка для летних экскурсий. Зимой здесь можно кататься на коньках и
                                                собачьих
                                                упряжках.
                                            </p>
                                        </div>
                    ...
                    <div class="post-details__user user">
                        <div class="post-details__user-info user__info">
                            ...
                            <div class="post-details__name-wrapper user__name-wrapper">
                                ...
                                <time class="post-details__time user__time"
                                      datetime="<?= show_date(($val['timestamp_add']), 'datetime_format'); ?>"><?= show_date(($val['timestamp_add']), 'relative_format'); ?>
                                    на сайте
                                </time>
                            </div>
                        </div>
                        <div class="post-details__rating user__rating">
                            <p class="post-details__rating-item user__rating-item user__rating-item--subscribers">
                                <span
                                    class="post-details__rating-amount user__rating-amount"><?= $authorSubscribersCount ?></span>
                                <span class="post-details__rating-text user__rating-text">подписчиков</span>
                            </p>
                            <p class="post-details__rating-item user__rating-item user__rating-item--publications">
                                <span
                                    class="post-details__rating-amount user__rating-amount"><?= $authorPostsCount ?></span>
